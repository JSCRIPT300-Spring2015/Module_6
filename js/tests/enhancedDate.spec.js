describe('enhancedDate', function(){
	describe('setDate', function() {
		...
		it('should return an object identical to the one passed in', function() {
			expect(enhancedDate.setDate(new Date(2015, 6, 7))).to.be.deep.equal(new Date(2015, 6, 7));
		});
	});
	...
	describe('getDayName', function() {
		...
		before(function() {
			enhancedDate.setDate(new Date("6/7/2015"));
		});
	...
	describe('isToday', function() {
		...
		it('should return a true if it is today', function() {
	...
	describe('isFuture', function() {
		...
		it('should return a true if it is in the future', function() {
			enhancedDate.setDate(new Date("6/7/2116"));
			expect(enhancedDate.isFuture()).to.be.true;
		});
		
		it('should return false if it is in the past', function() {
			enhancedDate.setDate(new Date("6/5/2014"));
